...
-- Las pilas siguen el orden LIFO. Porque el último elemento en entrar (apilado), es el primero en salir (desapilado).
...
-- La ventaja que tiene usar listas enlazadas en lugar de arreglos es que no se tiene el límite de tamaño como en las listas de arreglos, haciendo que la pila pueda tener un tamaño dinámico. También se podría implementar una pila sobre una lista de arreglos, pero algunas operaciones requieren un corrimiento de los elementos al cambiar de tamaño el arreglo.
