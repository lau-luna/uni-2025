...
public class Album {
    ...
    public Album(String titulo, String artista, int anho, boolean enVivo) {
        ...
        if (anho < 1900)
            throw new IllegalArgumentException("anho debe >= 1900");
    ...
    public String toString() {
        if (esEnVivo()) {
            return String.format("%s (año %d). Artista: %s. Album en vivo", titulo, anho, artista);
        } else {
            return String.format("%s (año %d). Artista: %s.", titulo, anho, artista);
        }
    }
