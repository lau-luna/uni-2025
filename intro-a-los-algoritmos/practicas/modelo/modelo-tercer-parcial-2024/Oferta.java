...
public class Oferta
{
     ...
     * El oferente debe ser no nulo y no vacío. 
     * El monto mayor a cero y menor o igual a oferta maxima.
     * @param oferente es el oferente de la oferta
     * @param monto es el monto de la oferta
     */
    public Oferta(String oferente, int monto)
    {
        assert oferente != null && oferente.length() > 0 : "Oferente nulo o vacio";
    ...
    public boolean repOK() {
        return nombre != null && nombre.length() > 0 && monto > 0;
    }
}
